...
const Projects = () => {
  ...
  return (
    <section className='px-6 py-10' id='work'>
      <h1 className='text-4xl md:text-6xl font-medium text-white tracking-tighter mb-10'>Work</h1>
      ...
      {PROJECTS.map((project) => (
              ...
              >
                ...
                className='absolute inset-0 transition-opacity duration-300 h-auto w-full object-cover' />
                  <div className='relative z-20 p-6 flex flex-col justify-between h-full bg-black/30 text-white'>
                    ...
                    <div className='flex flex-col justify-between'>
                      ...
                      className='bg-white text-slate-900 rounded-full py-2 px-2 w-32 text-sm hover:bg-gray-100 text-center'
                      >
                        View on Github
                      </a>
                    </div>
